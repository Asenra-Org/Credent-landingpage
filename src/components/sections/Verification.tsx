      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 lg:gap-24 items-center">
        ...
        <div className="flex-1 order-1 md:order-2">
          ...
          <p className="text-lg text-secondary leading-relaxed max-w-md">
            Surface inconsistencies for review. Cresem automatically compares financial metrics across different documents to identify structural risks before manual human review even begins.
          </p>
        </div>
