    ...
    <section className="bg-white border-t border-border">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 lg:gap-24">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-secondary leading-relaxed max-w-md">
              Cresem is designed to support controlled enterprise deployment models, ensuring your data never leaves a trusted boundary.
            </p>
          </div>
          
          <div className="flex-1 flex flex-col gap-12 font-mono text-sm">
            <div className="border-t-2 border-brand pt-6">
              <h3 className="font-bold tracking-widest text-brand uppercase mb-4">Cresem-Managed</h3>
      ...
      <div id="access" className="py-16 md:py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="mb-12">
            <Image src="/logo.jpg" alt="Cresem Logo" width={48} height={48} className="w-12 h-12 object-contain" />
          </div>
          ...
          <p className="text-xl text-secondary max-w-2xl mx-auto mb-16 leading-relaxed">
            Cresem is being built to turn fragmented borrower information into structured, reviewable credit intelligence.
          </p>
