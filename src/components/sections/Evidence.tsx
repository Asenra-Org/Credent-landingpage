      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-secondary leading-relaxed mb-12">
            Credent is designed around evidence-backed credit review. Every extracted data point is explicitly mapped back to the underlying financial document, page, and exact field coordinate.
          </p>
        </div>
