    ...
    <section ref={containerRef} className="py-16 md:py-24 px-6 bg-white border-t border-border">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <p className="text-lg text-secondary leading-relaxed max-w-2xl mb-24">
          ACAS is not an autonomous lending system. It structures the data and verifies the math, handing a clean, auditable file to your authorized personnel for final sign-off.
        </p>
