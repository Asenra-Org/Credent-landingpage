      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-32 items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg text-white/60 leading-relaxed">
            Cresm's architecture ensures enterprise-grade security and compliance. From strict role-based access control to immutable audit logs, every step of the credit process is secure, traceable, and structurally sound.
          </p>
        </div>
