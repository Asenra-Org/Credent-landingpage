        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-secondary leading-relaxed mb-6">
              No complex SDKs or legacy protocols. Our API is built on modern web standards, returning predictable, strongly-typed JSON. Whether you're building a custom frontend or integrating with a legacy core banking system, Credent adapts to your stack.
            </p>
      ...
      <section className="py-16 md:py-24 px-6 border-t border-border bg-background">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             ...
             <div className="w-full max-w-sm">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-bold mt-2 uppercase tracking-wider text-secondary">Credent Engine</span>
                  </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-secondary leading-relaxed mb-6">
              Financial document parsing is inherently asynchronous. Instead of forcing your systems to poll our API continuously, Credent utilizes webhooks and Server-Sent Events (SSE) to notify your backend the exact millisecond a credit file is ready.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
