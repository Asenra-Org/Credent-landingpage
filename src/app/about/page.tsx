      ...
      <section className="py-16 md:py-24 px-6 border-t border-border bg-background">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-6 text-lg text-secondary leading-relaxed">
            ...
            <p>
              <strong className="text-brand font-semibold">Asenra built Credent to flip that ratio.</strong>
            </p>
            <p>
              By leveraging deterministic AI and advanced computer vision, Credent automates the extraction, verification, and cross-referencing of complex financial documents. We turn hours of manual grunt work into two minutes of automated intelligence.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-6 border-t border-border">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="border border-border p-8 bg-background relative group">
