      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24 px-6 bg-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-secondary leading-relaxed max-w-2xl mx-auto">
            A deep dive into how ACAS processes, verifies, and analyzes financial documents to give credit teams superhuman analytical abilities.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-secondary leading-relaxed mb-6">
              Fraudulent financial documents are becoming increasingly sophisticated. ACAS's AI goes beyond OCR, analyzing file metadata, font subsetting anomalies, and hidden layer manipulations to detect tampered bank statements and tax returns instantly.
            </p>
