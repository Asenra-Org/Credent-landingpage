      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-white/70 leading-relaxed max-w-2xl mx-auto">
            Credent is built for institutional finance. We operate under strict data handling protocols designed to meet and exceed regulatory requirements for Banks and NBFCs.
          </p>
        </div>
      </section>
          ...
          <div className="bg-background text-brand border border-border p-10 flex flex-col justify-between group hover:border-primary/50 transition-colors">
            <div>
              ...
              <p className="text-secondary leading-relaxed mb-8">
                Every financial document uploaded to Credent is processed inside a securely isolated, ephemeral container environment. Once the structured data (CAM) is generated and returned to your systems, the raw document and its trace are immediately wiped from working memory. 
              </p>
            </div>
